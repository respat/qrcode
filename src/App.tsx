...
const App: React.FC = () => {
  ...
  // === 1. QRCode Inicializálása és DOM-hoz kapcsolása + Google Analytics betöltése ===
  useEffect(() => {
    // QR kód hozzáadása
    if (ref.current) {
    ...
    // Google Analytics betöltése (helyesen React-ben)
    const script1 = document.createElement("script");
    script1.async = true;
    script1.src = "https://www.googletagmanager.com/gtag/js?id=G-WECQ2QKPBJ";
  ...
  return (
    <div className="min-h-screen bg-gray-100 flex flex-col items-center justify-center p-4 sm:p-6 text-gray-900">
      ...
      <div className="mt-8 w-full max-w-sm text-center p-4 border-2 border-dashed border-gray-300 bg-white rounded-xl shadow-md">
        {/* Ide jöhet pl. Ko-fi vagy BuyMeACoffee gomb a jövőben */}
      </div>
      ...
      <CookieConsent
        ...
        expires={150}
      >
        This page uses cookies for a better experience (Analytics, preferences).{" "}
        <a
          href="/adatvedelem"
